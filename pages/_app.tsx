...
// TODO: - navbar color, Shopping Cart Icon with badge, Order details icons, Trash icon background, Links to sites, dashboard css, animations for home page, github, loading icon, possibly add stripe payment
